...
public interface BoundedQueue<T>{
	...
	public default boolean isEmpty() { // is the buffer empty (fillCount equals zero)?
		return fillCount() == 0;
	}
	public default boolean isFull() { // is the buffer full (fillCount is same as capacity)?
