...
public class GraphBuilder {
    ...
    /** Graph for Question3_1. */
    public static MyGraph<Node, Weight> buildQuestion3_1(int[] path) {
        MyGraph<Node, Weight> G;
        G = new MyGraph<>(path.length);
        Node n0 = new Node(0, 1, 0 * 3 - 238);
        Node n1 = new Node(1, 1.5, 70 * 3 - 226);
        Node n2 = new Node(2, 2, 90 * 3 - 214);
        Node n3 = new Node(3, 3, 0 * 3 - 202);
        Node n4 = new Node(4, 5, 90 * 3 - 190);
        Node n5 = new Node(5, 2.5, 0 * 3 - 178);
        Node n6 = new Node(6, 5, 30 * 3 - 165);
        Node n7 = new Node(7, 2.5, 100 * 3 - 153);
        Node n8 = new Node(8, 3.5, 140 * 3 - 141);
        Node n9 = new Node(9, 2, 80 * 3 - 129);
        Node n10 = new Node(10, 2.5, 30 * 3 - 117);
        Node n11 = new Node(11, 5, 115 * 3 - 105);
        Node n12 = new Node(11, 6, 130 * 3 - 93);
        Node n13 = new Node(11, 4, 100 * 3 - 81);

        // path = {2,3,1,0,4,6,5,7,8,11,9,10,12,13};
        Weight w23 = new Weight(0.77, 1);
        Weight w31 = new Weight(0.9, 1);
        Weight w10 = new Weight(0.13, 1);
        Weight w04 = new Weight(2.9, 84);
        ...
        Weight w119 = new Weight(1.23, 15);
        Weight w910 = new Weight(4, 26);
        Weight w1012 = new Weight(5.6, 431);
        Weight w1213 = new Weight(0.9, 140);
        ...
        G.addEdge(n11, n9, w119);
        G.addEdge(n9, n10, w910);
        G.addEdge(n10, n12, w1012);
        G.addEdge(n12, n13, w1213);
        return G;
    }

    /** Graph for Question3_2. */
    public static MyGraph<Node, Weight> buildQuestion3_2(int[] path) {
        MyGraph<Node, Weight> G;
        G = new MyGraph<>(path.length);
        ...
        Node n12 = new Node(11, 6, 130 - 93);
        Node n13 = new Node(11, 4, 100 - 81);
